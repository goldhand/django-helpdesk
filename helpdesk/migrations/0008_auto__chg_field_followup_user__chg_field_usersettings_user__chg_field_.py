...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FollowUp.user'
        db.alter_column(u'helpdesk_followup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True))

        # Changing field 'UserSettings.user'
        db.alter_column(u'helpdesk_usersettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.User'], unique=True))

        # Changing field 'Ticket.assigned_to'
        db.alter_column(u'helpdesk_ticket', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))

        # Changing field 'SavedSearch.user'
        db.alter_column(u'helpdesk_savedsearch', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))

        # Changing field 'TicketCC.user'
        db.alter_column(u'helpdesk_ticketcc', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True))

    def backwards(self, orm):

        # Changing field 'FollowUp.user'
        db.alter_column(u'helpdesk_followup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'UserSettings.user'
        db.alter_column(u'helpdesk_usersettings', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Changing field 'Ticket.assigned_to'
        db.alter_column(u'helpdesk_ticket', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'SavedSearch.user'
        db.alter_column(u'helpdesk_savedsearch', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'TicketCC.user'
        db.alter_column(u'helpdesk_ticketcc', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'helpdesk.customfield': {
            ...
            'empty_selection_list': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'helpdesk.ticket': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_to'", 'null': 'True', 'to': u"orm['users.User']"}),
        ...
        u'users.user': {
            ...
            'active_ind': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            ...
            'last_updated_by': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'member_dba_name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'member_legal_name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
            'rec_create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'rec_delete_ind': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
